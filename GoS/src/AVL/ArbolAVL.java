...
public class ArbolAVL {
     ...
     */
    public ArbolAVL(Comparator cmp){
    	this.comparador = cmp;
    }
     ...
     */
    public boolean add(Dragon e) throws ClassCastException, NullPointerException, IllegalStateException{
    	...
    	if(raizTmp == null){
    		this.raiz = nodo;
    		nodo.getDato().setX(xraiz);
    		nodo.getDato().setY(yraiz);
    		return true;
    	}else
	 ...
	 * @return true if this collection changed as a result of the call.
	 */
    public boolean addAll(Collection<? extends Dragon> c) throws ClassCastException, NullPointerException, IllegalStateException{
    	Iterator<? extends Dragon> iter = (Iterator<? extends Dragon>) c.iterator();
    	Iterator<? extends Dragon> iter2 = (Iterator<? extends Dragon>) c.iterator();
    	Dragon dato, primero;
     ...
     */ 
    public void clear(){
    	Iterator<Dragon> iter = (Iterator<Dragon>) this.iterator();
     ...
     */
    public boolean contains(Dragon o) throws ClassCastException, NullPointerException{
    	Nodo raizTmp = this.getRaiz();
    	if(this.isEmpty()){
    		return false;
    	}
    ...
    public Iterator<Dragon> iterator(){
    	List<Dragon> lista= this.inOrden();
    	Iterator<Dragon> iter = lista.iterator();
     ...
     * @throws NullPointerException - if the specified element is null and this collection does not permit null elements (optional).
     */
    public boolean remove(Dragon o) throws ClassCastException, NullPointerException{
    ...
    public boolean retainAll(Collection<?> c) throws ClassCastException, NullPointerException{
    	List<Dragon> listaArbol = this.preOrden();
    	List<Dragon> listaBorrar = new ArrayList<Dragon>();
    	Dragon dato;
     ...
     */
    public int profundidad(Dragon dato){
     ...
     */
    public Nodo getNodo(Dragon dato){
     	Nodo raizTmp = this.getRaiz();
     ...
     */
    private Comparator<Dragon> getComparator(){
     ...
     * @return dato
     */
    public Dragon extraeDato(Nodo nodo){
    	return nodo.getDato();
    }
	...
	private class Nodo{
		 ...
		 */
		public void setDato(Dragon dato){
			this.dato = dato;
		}
